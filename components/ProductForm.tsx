  ...
  return (
    <form onSubmit={submit} className="space-y-3">
      ...
      <div className="flex gap-2">
        <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-green-500 to-yellow-500 text-white font-semibold"
          type="submit">Save Product</button>
        <button type="button" onClick={() => { setName(''); setSku(''); setGram('') }}
          className="px-4 py-2 rounded-lg border">Reset</button>
      </div>
    </form>
  )
}
